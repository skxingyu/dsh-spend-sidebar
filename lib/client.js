					...
					react_jsx_runtime.jsx(Section, {
						...
						children: react_jsx_runtime.jsx(BreakdownTable, {
							...
							renderRow: (row) => [
								...
								react_jsx_runtime.jsx("td", { className: "dsu-num", children: `${currencySymbol(currency)}${formatRateNum(row.inputPerMillion, rate)}` }),
								react_jsx_runtime.jsx("td", { className: "dsu-num", children: `${currencySymbol(currency)}${formatRateNum(row.outputPerMillion, rate)}` }),
								react_jsx_runtime.jsx("td", { className: "dsu-num", children: `${currencySymbol(currency)}${formatRateNum(row.cacheReadPerMillion, rate)}` }),
								react_jsx_runtime.jsx("td", { className: "dsu-num", children: `${currencySymbol(currency)}${formatRateNum(row.cacheWritePerMillion, rate)}` }),
							],
						}),
					}),
				],
