...
usageEndpoints;
    ...
    constructor(ctx, config = {}) {
      ...
      }, "dsh-spend-sidebar: reset cache on unload");
    }
    ...
    async compute(signature, live, cwd) {
      ...
      const stats = buildStats(calls, pricing, this.defaultPricing, {
        ...
        plans: mergedPlans,
        // Mixed-currency pricing rows (the billing-plugin catalog keeps each
        // model's native currency) are converted into `this.currency` here.
